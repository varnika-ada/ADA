...
with open("binarysearchoutput.txt", "r") as file:
    for line in file:
...
for n in array_size:
    best_case.append(1)               # O(1)
    avg_case.append(math.log2(n))     # O(log n)
    worst_case.append(math.log2(n))   # O(log n)
